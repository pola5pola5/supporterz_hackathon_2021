...
<script>
    ...
    export default {
        ...
        methods:{
            //get json
            init: async function(){
                await axios.get("http://54.64.77.173:1323/api/trip/get?trip_id=" + this.$store.state.tripid)
                .then(res => {this.geojsonData = res.data, this.mapCreate(this.geojsonData, this.geocoordinate)});
            },
